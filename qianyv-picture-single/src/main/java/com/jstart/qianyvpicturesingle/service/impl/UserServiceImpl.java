...
import com.jstart.qianyvpicturesingle.common.enums.RoleEnum;
...
import com.jstart.qianyvpicturesingle.mapper.UserMapper;
import com.jstart.qianyvpicturesingle.model.dto.user.UserLoginDTO;
import com.jstart.qianyvpicturesingle.model.dto.user.UserQueryRequest;
import com.jstart.qianyvpicturesingle.model.dto.user.UserRegisterDTO;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public boolean isAdmin(User user) {
        return user != null && RoleEnum.ADMIN.getValue().equals(user.getUserRole());
    }
